    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {
                ...
                "mc_labels" if args.model_type == 'gpt' else "labels": batch[3],
            }
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        for batch in tqdm(eval_dataloader, desc="Evaluating"):
            ...
            if preds is None:
                ...
                if args.model_type == 'gpt':
                    out_label_ids = inputs["mc_labels"].detach().cpu().numpy()
                else:
                ...
                #print(preds)
                if args.model_type == 'gpt':
                    out_label_ids = np.append(out_label_ids, inputs["mc_labels"].detach().cpu().numpy(), axis=0)
                else:
